...
function SearchPanel() {
  ...
  function search(value) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield loadPagefind()
      if (pagefind) {
        const res = yield pagefind.search(value)
        const nextResults = yield Promise.all(res.results.map((r) => r.data()))
...
function useSearchKeyboardEvents({ onOpen }) {
  useEffect(() => {
...
//# sourceMappingURL=SearchButton.jsx.map
