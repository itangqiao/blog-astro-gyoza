...
export function TimelineProgress() {
  ...
  return (
    <>
      <p className="mt-4">
        今天是 {currentYear} 年的第 <CountUp to={dayOfYear} decimals={0} /> 天 ， 今年已过{' '}
        <CountUp to={percentOfYear} decimals={3} />
        %， 今天已过 <CountUp to={percentOfToday} decimals={3} />%
      </p>
    </>
  )
}
function CountUp({ to, decimals, duration = 1 }) {
...
//# sourceMappingURL=TimelineProgress.jsx.map
